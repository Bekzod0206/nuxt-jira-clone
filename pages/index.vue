<template>
  <main class="pb-72">
    ...
    <!--  -->
    <section>
      <h1 class="text-4xl font-medium text-center mt-20">Easer than ever</h1>
        ...
        <div class="bg-blue-500 dark:bg-blue-800 p-8">
            ...
            <div class="flex flex-col mt-4">
              <div class="bg-gray-500 dark:bg-gray-800 flex items-center gap-5 h-20">
                <div class="flex justify-center items-center bg-blue-500/30 dark:bg-blue-800/30 p-3 h-full">
                  <NuxtImg v-if="item" :src="item.image" class="w-12" />
                </div>
          ...
          >
            ...
            <div class="pl-2 opacity-70">
              ...
              <p class="text-sm">AGILE DELIVERY AMANAGER, CANCER RESEARCH UK</p>
            </div>
          </div>
        </div>
